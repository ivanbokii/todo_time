...
(function() {
  ...
  requirejs(['parser', 'scanner', 'input_reader', 'scanner_words_analyser', 'time_patterns_analyser', 'duration_patterns_analyser'], function(Parser, Scanner, InputReader, ScannerWordsAnalyser, TimePatternsAnalyser, DurationPatternsAnalyser) {
    window.todo = {};
